...
def add_model_config_args(parser):
    ...
    group.add_argument(
        "--base", type=str, nargs="*", help="config for input and saving"
    )
    group.add_argument(
        "--model-parallel-size",
        type=int,
...
def add_sampling_config_args(parser):
    ...
    # for pose
    group.add_argument("--use_pose", type=bool, default=False)
    group.add_argument("--representation", type=str, default="dwpose")
    group.add_argument("--save_tag", type=str, default="default")
    group.add_argument("--multi_cond_cfg", type=bool, default=False)
    return parser
